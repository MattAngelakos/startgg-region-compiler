  ...
  const filteredSeasons = useMemo(() => {
    ...
    return region.seasons.filter((season) => {
      const matchesPlayersQuery = filterPlayersQuery
        ...
        : true;
      const matchesTournamentsQuery = filterTournamentsQuery
        ? season.seasonName.toLowerCase().includes(filterTournamentsQuery.toLowerCase())
        : true;
      return matchesPlayersQuery && matchesTournamentsQuery;
    }).map((season) => ({
      ...season,
      _id: season.seasonName,
    }));
  }, [region, filterPlayersQuery, filterTournamentsQuery]);
